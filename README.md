...
Секреты были вырезаны из docker-compose. Если вы хотите уведомления в Telegram/Slack - подключите токены и Chat/Channel айди.

## Inlining

Variables не были вынесены в .env файл за неимением времени.